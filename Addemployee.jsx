...
function AddEmployee({ cancelEmployeClick, tempData }) {
    ...
    //     if (checked) {
    //         setskillss([...skillss, value])
    //     }
    //     else {
    //         setskillss(skillss.filter((e) => e !== value))
    //     }
    // }
                ...
                <div className='row mt-3'>
                    ...
                    <div className='col-md-9'>
                        <div className='row w-75'>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="Programming" className="me-1" id="Programming" />
                                <label htmlFor="Programming">Programming</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="Communication" className="me-1" id="Communication" />
                                <label htmlFor="Communication">Communication</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="ProCommunication" className="me-1" id="ProCommunication" />
                                <label htmlFor="ProCommunication">ProCommunication</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="Finance" className="me-1" id="Finance" />
                                <label htmlFor="Finance">Finance</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="Recruitment" className="me-1" id="Recruitment" />
                                <label htmlFor="Recruitment">Recruitment</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="Optimization" className="me-1" id="Optimization" />
                                <label htmlFor="Optimization">Optimization</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="AppDevelopment" className="me-1" id="AppDevelopment" />
                                <label htmlFor="AppDevelopment">App Development</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="FrontendDevelopment" className="me-1" id="FrontendDevelopment" />
                                <label htmlFor="FrontendDevelopment">Frontend Development</label>
                            </div>
                            <div className='col-4'>
                                <input onChange={changecheckbox} value={{}} type="checkbox" name="BackendDevelopment" className="me-1" id="BackendDevelopment" />
